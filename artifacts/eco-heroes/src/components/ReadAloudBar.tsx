...
const PAGE_SCRIPT = [
  "Welcome to the Schools Energy Competition for all Northern Ireland pupils, 3 to 14 years. We challenge your school's Eco-Committee — or pupils — to take on the Energy topic and continue or start your Eco-flag journey.",
  "Meet our Eco-Heroes Eco-Committee. Electric Leisha is the EV Champion — her mission is converting NI roads to electric, helping families and schools switch to electric vehicles to slash emissions and cut running costs. Akshara is the Water Guardian — every drop counts, and she teaches schools how saving water also saves the energy used to heat and pump it. Veggie Man is the Plant Power Hero — save the planet one meal at a time, showing how swapping meat for plants cuts carbon with every bite. Heather O'Hare is the Mind and Mine Keeper — protecting both the land beneath our feet and the wellbeing of the people above it, championing responsible use of Northern Ireland's natural resources. And Kaizen Ken is the Renewable Ranger and Green-skills Champion — Solar Warrior, Sun Storer and Renewables for All, championing the free energy from the sun and harnessing free wind energy for everyone. To the future and beyond!",
  "Why enter? Five schools will each win eco-refurbished laptops for their Eco-Committee — or you can win for your school if you're just starting your eco-flag journey. You also earn points towards your Eco-Schools Green Flag, receive a free Digital Certificate, and your school is featured as an Eco Hero Champion.",
  "How to enter: Use the Mission Builder on this page to write your school mission statement. Download it in PDF for your records, your entrance hall wall or website, and simply click Submit to enter.",
  "Prizes: Five eco-refurbished laptops — one per winning school. Plus your Eco-Schools Green Flag points, a Digital Certificate, and your school featured as an Eco Hero Champion.",
  "Key dates: The competition opens on Monday the 1st of June and closes on Tuesday the 16th of June. Winners are announced on Thursday the 18th of June.",
  ...
  "This competition is powered by NIEAS for our Schools Energy Awareness Programme, sponsored by the Housing Executive, for the Eco-Schools Northern Ireland Energy Topic.",
