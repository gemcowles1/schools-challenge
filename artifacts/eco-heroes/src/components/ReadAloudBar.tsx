...
const PAGE_SCRIPT = [
  ...
  "Meet our Eco Heroes. Solar Saoirse uses solar power to save energy every day. Wind Warrior Ciarán harnesses wind energy. Insulation Ivan keeps homes warm without waste. Efficiency Emma turns off everything not in use. Watt Watcher Willow measures and reduces energy use. All Abilities Champion Circuit Katie believes green energy is for everyone — no barriers, no waste.",
