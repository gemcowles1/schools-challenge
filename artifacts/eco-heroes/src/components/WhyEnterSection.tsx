...
export function WhyEnterSection() {
  const reasons = [
    ...
    },
    {
      ...
      body: "Five schools will each win an eco-refurbished laptop for their Eco-Committee — or you can win for your school if you're just starting your eco-flag journey. Enter your mission statement for your chance to be one of the five winners!",
      rotate: "-rotate-1",
    },
    {
      emoji: "⭐",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-2">
            ...
            <span className="bg-accent text-white font-black px-4 py-2 rounded-full uppercase tracking-wide whitespace-nowrap">Free Entry</span>
