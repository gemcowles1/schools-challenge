          ...
          <div className="mt-8 animate-in fade-in duration-1000 delay-500">
            ...
            <div className="text-center mt-6">
              ...
              <p className="mt-4 text-base md:text-lg font-bold text-foreground/70 max-w-xl mx-auto leading-snug">
                Write your school's <span className="whitespace-nowrap">Eco-Hero</span> mission statement, earn points towards your <span className="text-primary font-black whitespace-nowrap">Eco-Schools Green Flag</span>, and be in with a chance to win one of <span className="text-secondary font-black whitespace-nowrap">5 eco-refurbished laptops</span> for your <span className="whitespace-nowrap">Eco-Committee</span> — or for your school if you're just starting your eco-schools journey.
              </p>
            </div>
          </div>
        </div>
